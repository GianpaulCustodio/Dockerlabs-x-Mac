...
# â”€â”€ CAMBIO: Aviso temprano en macOS sobre la accesibilidad de red de contenedores â”€â”€
...
# â”€â”€ FIN CAMBIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
for name in "$@"; do
    ...
    if [ ! -z "$image_id" ]; then
        echo -e "\033[38;5;230;1mSe han detectado máquinas de DockerLabs previas, debemos limpiarlas para evitar problemas, espere un momento...\033[0m"
...
function ctrl_c() {
    echo -e "\033[1mEliminando el laboratorio, espere un momento...\033[0m"
    detener_y_eliminar_contenedor
...
echo -e "\033[1;93m\nEstamos desplegando la máquina vulnerable, espere un momento.\033[0m"
detener_y_eliminar_contenedor
...
if [ $? -eq 0 ]; then
    ...
    # - macOS ARM reporta "arm64"   â†’ rama Darwin
    # - Linux ARM64 reporta "aarch64" â†’ rama Linux ARM (cubre VMs sobre Mac Apple Silicon)
    # - x86_64 Intel/AMD            â†’ rama else, comportamiento original
    ...
    echo -e "\033[1;96m\nMáquina desplegada, su dirección IP es --> \033[0m\033[1;97m$IP_ADDRESS\033[0m"
    echo -e "\033[1;91m\nPresiona Ctrl+C cuando termines con la máquina para eliminarla\033[0m"

else
    echo -e "\033[91m\nHa ocurrido un error al cargar el laboratorio en Docker.\033[0m"
    exit 1
fi
